package org.aadi.bookstore.orders.testdata;
...
import org.aadi.bookstore.orders.domain.models.Address;
...
public class TestDataFactory {
    ...
    static final Set<OrderItem> VALID_ORDER_ITEMS =
            Set.of(new OrderItem("P100", "The Hunger Games", new BigDecimal("34.0"), 1));
